...
| Need | Start here |
| --- | --- |
| Activate PDMShell on a computer with internet access | [License Activation](license-activation.md) |
...
1. Install PDMShell.
2. Activate the local workstation license with [License Activation](license-activation.md) or [Offline Activation](offline-activation.md).
3. If you use the PDMShell add-in, decide between [License Pool](license-pool.md) and [Machine License](machine-license.md).
4. Configure add-in licensing from [Manage PDMShell add-in licenses](addin/license-manager.md).
